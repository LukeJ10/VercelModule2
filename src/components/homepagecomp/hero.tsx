    ...
    <div className="flex items-center justify-between p-[6rem] bg-gray-100 min-h-[600px] mt-20">
      <div className="flex flex-col gap-0">
        ...
        <div className="hidden lg:block md:block max-w-md">
          <Image 
            src="/images/egg.png" 
            className="hidden md:hidden lg:block opacity-60 pt-10 mb-0 pb-0 pl-[7rem]" 
            width={350} 
            height={350} 
            alt="Arasaki Games Studio" 
          />
        </div> 
      </div>
      <div>
        <Image 
          src="/images/hero.png"  
          className="hidden md:block lg:block max-w-[38rem] align-middle items-start" 
          width={608} 
          height={608} 
          alt="Hero Image" 
        />
